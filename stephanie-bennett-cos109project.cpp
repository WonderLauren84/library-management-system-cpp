...
public:
    ...
    // Search for a book by title (case-insensitive & partials)
...
// ----------------------------------------------------
// Main function
// Now uses a menu so the user can interact with
// the library system instead of only hardcoded tests
